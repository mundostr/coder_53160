...
router.get('/:page', async (req, res) => {
    try {
        const products = await manager.getPaginated(config.PRODUCTS_PER_PAGE, parseInt(req.params.page));
...
router.put('/:id', verifyToken, handlePolicies('admin', 'premium'), async (req, res) => {
    try {
