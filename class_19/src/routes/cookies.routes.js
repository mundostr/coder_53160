...
router.get('/getcookies', async (req, res) => {
    try {
        /**
         * Cuando el cliente realiza una solicitud, las cookies
         * relacionadas llegan en el request (req):
         * 
         * Si son cookies standard: req.cookies
         * Si son cookies firmadas: req.signedCookies
         */
...
router.get('/setcookie', async (req, res) => {
    try {
        /**
         * Con res.cookie notificamos al navegador que debe generar una cookie
         * bajo el nombre y características indicadas.
         * 
